			...
			<form action="join_ok.php" method="post">
				<div id="join_f">
					<div class="form-group">
						...
						<div class="mb"><input type="text" class="inp" id="userid" name="userid" placeholder="아이디" onkeyup="idcheck" /></div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="mb"><input type="password" class="inp" id="userpw2" name="userpw2" placeholder="비밀번호 확인" /></div>
