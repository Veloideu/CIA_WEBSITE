<?php
	include $_SERVER['DOCUMENT_ROOT']."/security/db.php"; /* db load */
...
<meta charset="UTF-8">
<title>게시판</title>
<link rel="stylesheet" type="text/css" href="/assets/board_css/read_jquery-ui.css" />
<link rel="stylesheet" type="text/css" href="/assets/board_css/board_style.css" />
...
<div id="board_read">
	 <h2>제목 : <?php echo $board['title']; ?></h2>
		<div id="user_info">
			아이디 : <?php echo $board['name']; ?> <?php echo $board['date']; ?> 조회:<?php echo $board['hit']; ?>
				<div id="bo_line"></div>
			</div>
			<div>
...
<div class="reply_view">
	<h3>댓글목록</h3>
		...
		?>
		<div class="dap_lo">
			<div><b>아이디 : <?php echo $_SESSION['userid'];?></b></div>
			<div class="dap_to comt_edit">내용: <?php echo nl2br("$reply[content]"); ?></div>
